...
const META: Record<string, { priority: number; changefreq: string }> = {
  ...
  '/blog/ai-custom-software-trends-kerala-2026/': { priority: 0.8,  changefreq: 'weekly'  },
  '/blog/why-kannur-is-keralas-saas-innovation-hub/': { priority: 0.8, changefreq: 'weekly' },
...
export const GET: APIRoute = ({ site }) => {
  ...
  const base = (site?.toString() ?? 'https://www.klay.agency/').replace(/\/$/, '');
